...
function TopBar() {
  ...
  return (
    <header className="w-full text-white bg-gray-800/50 fixed z-50 backdrop-blur-9xl  top-0 left-0 right-0">
      <nav className="flex items-center justify-between px-5 py-3 max-w-[1440px] mx-auto">
        {/* Logo */}
        <div className="flex items-center gap-2">
          <FaTools className="text-yellow-400" size={26} />
          <h1 className="text-xl font-bold tracking-wide">Balaji Garage</h1>
        </div>
        ...
        <a href="tel:+919166306480" className="hidden md:flex items-center gap-1 bg-yellow-400 text-black px-4 py-2 rounded-lg font-semibold shadow hover:bg-yellow-300" >
      ...
      {open && (
        <ul className="md:hidden bg-gray-800/50 backdrop-blur-9xl text-white px-5 py-4 space-y-4 shadow-inner">
